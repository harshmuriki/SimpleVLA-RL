...
# If LIBERO is not installed via pip, set path to LIBERO repo root (parent of libero/ package)
export LIBERO_PATH="${LIBERO_PATH:-/home/hice1/vmuriki3/scratch/LIBERO}"
PROJECT_NAME='SimpleVLA-RL'
EXPERIMENT_NAME='vla-lib10_exp1' 
...
SFT_MODEL_PATH="/home/hice1/vmuriki3/scratch/hf-cache/models--Haozhan72--Openvla-oft-SFT-libero10-trajall/snapshots/97d6e58bc5fbc402e85bab382e4206bb8e5f0db0"
CKPT_PATH="/home/hice1/vmuriki3/scratch/SimpleVLA-RL/checkpoints"
# DATASET_NAME can be libero_10 (libero_Long), libero_90, libero_spatial, libero_object, libero_goal
DATASET_NAME="libero_10"
VLA_NAME="openvla-oft"
# Must match GPUs available to Ray (e.g. 1 if you see "No available node types can fulfill resource request")
NUM_GPUS=1
# If you want to use 2*8 GPU to RL. Set NUM_NODES=2
NUM_NODES=1 
ALIGN_PATH="/home/hice1/vmuriki3/scratch/SimpleVLA-RL/align.json"
